...
const replacements = [
  ...
  { pattern: /\sinner\sjoin|\sINNER\sJOIN/g, replacement: '\nINNER JOIN'},
  { pattern: /\sright\sjoin|\sRIGHT\sJOIN/g, replacement: '\nRIGHT JOIN'},
  { pattern: /\souter\sjoin|\sOUTER\sJOIN/g, replacement: '\nOUTER JOIN'},
  { pattern: /\swhere\s|\sWHERE\s/g, replacement: '\nWHERE\n'},
